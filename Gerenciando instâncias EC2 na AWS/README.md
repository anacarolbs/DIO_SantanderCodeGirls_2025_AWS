...
[Gerenciando EC2 instâncias da Amazon - Documentação AWS] (https://docs.aws.amazon.com/pt_br/toolkit-for-visual-studio/latest/user-guide/tkv-ec2-ami.html)

6 Materiais Complementares sobre GitHub 
[GitHub Quick Start - Repositório com Link para Aulas de Git e GitHub] (https://docs.aws.amazon.com/pt_br/toolkit-for-visual-studio/latest/user-guide/tkv-ec2-ami.html)
[GitBook: Formação GitHub Certification - Material textual sobre GitHub] (https://github.com/digitalinnovationone/github-quickstart)
